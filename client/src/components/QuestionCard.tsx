  ...
  return (
    ...
    >
      <div className="relative">
        {/* Glassmorphism Card */}
        <div className="relative bg-black/20 backdrop-blur-3xl rounded-3xl p-8 sm:p-12 border border-white/5 shadow-[0_32px_64px_rgba(0,0,0,0.6)] overflow-hidden">
          {/* Subtle Inner Glow */}
          ...
          <motion.div
            ...
            className="absolute -top-4 left-8 bg-indigo-500/20 backdrop-blur-xl text-white/90 px-6 py-2 rounded-full text-sm font-heading font-medium shadow-2xl border border-white/10"
          ...
          <motion.h2
            ...
            className="text-2xl sm:text-3xl font-heading font-medium text-white/80 text-center mb-12 mt-4 leading-relaxed tracking-tight"
